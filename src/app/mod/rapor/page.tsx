...
export default async function RaporlarModulPage() {
  const actor = await requirePagePermission("RAPORLAR", "GORUNTULE");
  const modüller: Modul[] = [
    {
      id: "rapor",
      etiket: "Raporlar",
      altModuller: [
        { href: "/raporlar", etiket: "Günlük Rapor", ikon: "rapor", dekont: "Alım, ödeme, tahsilat, emanet, masraf." },
  ...
  return <ModulSekmeler modüller={modulleriIzinlereGoreFiltrele(actor, modüller)} aktifId="rapor" />;
}
