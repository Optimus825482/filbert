...
-- 9. Mevcut FIRMA_SAHIBI ve sistem yetki rollerine HIZMET izinlerini ver
INSERT INTO "RolIzni" ("rolId", "modul", "eylem", "createdAt")
SELECT yr."id", 'HIZMET'::"UygulamaModulu", eylemler.eylem, CURRENT_TIMESTAMP
FROM "YetkiRolu" yr
CROSS JOIN (
    VALUES 
        ('GORUNTULE'::"IzinEylemi"),
        ('OLUSTUR'::"IzinEylemi"),
        ('GUNCELLE'::"IzinEylemi"),
        ('SIL'::"IzinEylemi"),
        ('ONAYLA'::"IzinEylemi"),
...
WHERE (yr."kod" = 'FIRMA_SAHIBI' OR yr."sistemRolu" = true)
ON CONFLICT ("rolId", "modul", "eylem") DO NOTHING;

-- 10. Mevcut firmalara varsayılan hizmet tiplerini ekle
INSERT INTO "HizmetTipi" ("id", "firmaId", "ad", "kirma", "kavurma", "paketleme", "varsayilanBirimFiyat", "sira", "aktif", "updatedAt")
SELECT 
...
CROSS JOIN (
    VALUES 
        ('Kırma', true, false, false, 2.50::numeric, 1),
        ('Kavurma', false, true, false, 5.00::numeric, 2),
        ('Kırma + Paketleme', true, false, true, 4.00::numeric, 3),
        ('Kırma + Kavurma + Paketleme', true, true, true, 8.00::numeric, 4)
) AS ht(ad, kirma, kavurma, paketleme, fiyat, sira)
ON CONFLICT ("firmaId", "ad") DO NOTHING;
